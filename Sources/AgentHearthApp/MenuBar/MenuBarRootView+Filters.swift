...
extension MenuBarRootView {
    ...
    var providerPicker: some View {
        if model.hostScopedSnapshots.count <= 3 {
            Picker("Provider", selection: $model.selection) {
                Text("All").tag(ProviderSelection.all)
    ...
    private var providerMenu: some View {
        Menu {
            Button {
                ...
                Label(
                    "All providers (\(model.hostScopedSnapshots.count))",
    ...
    private var selectedProviderName: String {
        ...
        case .all: "All providers (\(model.hostScopedSnapshots.count))"
    ...
    private var priorityFocusToggle: some View {
        ...
        let pinnedCount = model.sessionFocus.pinnedCount
        return Button {
